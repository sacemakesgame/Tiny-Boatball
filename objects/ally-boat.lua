AllyBoat = Boat:extend()
AllyBoat.home = vec3(-15, 0, 0)
AllyBoat.goal = vec3(15, 0, 0)

function AllyBoat:new(owner, v, role, character)
    AllyBoat.super.new(self, owner, v, character)
    self.kick_available = true
    self.role = role
end


function AllyBoat:update(dt)
    AllyBoat.super.update(self, dt)
...
function AllyBoat:update_physics()
...
function AllyBoat:destroy()
    self.owner.world:remove_body(self)    
end


function AllyBoat:nos()
    local dir = vec3()
